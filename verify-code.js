 ...
 * api/verify-code.js
 * ---------------------------------------------------------------
 * Checks the 6-digit code against its hash, server-side only —
 * the real code and its hash never reach the browser. Locks out
 * after 5 wrong attempts on a single code (brute-force guard) and
 * enforces the 10-minute expiry.
 * ---------------------------------------------------------------
 */
